        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text14">Web Development</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text21">App Development</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text27">Graphic Design</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-body-small thq-link">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Contact Me</span>
                  </Fragment>
                )}
              </span>
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text19">Graphic Design</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text24">Contact Me</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
